...
Rectangle {
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                TextField {
                    id: filterGenre
                    placeholderText: "Gatunek (np. RPG)"
                    Layout.fillWidth: true
        ...
        // ==========================================
        // SEKCJA DODAWANIA NOWEJ GRY (Rozwijana)
        // ==========================================
        Rectangle {
            id: addGameContainer
            Layout.fillWidth: true
            ...
            ColumnLayout {
                ...
                RowLayout {
                    Layout.fillWidth: true
                    Label {
                        text: addGameContainer.isExpanded ? "➖ Zwiń panel dodawania" : "➕ Dodaj nową grę do bazy"
                        font.bold: true
                        font.pixelSize: 16
                        color: "#212529"
                        Layout.fillWidth: true
                    ...
                    Button {
                        ...
                        onClicked: addGameContainer.isExpanded = !addGameContainer.isExpanded
                    }
                }
                ...
                ColumnLayout {
                    ...
                    GridLayout {
                        ...
                        TextField { id: inputDev; placeholderText: "* Deweloper"; Layout.fillWidth: true; background: Rectangle { color: "#f8f9fa"; border.color: "#ced4da"; radius: 4 } }
        ...
        ListView {
            ...
            delegate: Rectangle {
                ...
                height: Math.max(250, postRow.implicitHeight + 30) // Dynamiczna wysokość zależna od prawej kolumny
                color: "white"
                radius: 12
                border.color: "#cdd1d5"
                border.width: 1
                ...
                RowLayout {
                    ...
                    Image {
                        ...
                        source: game.image_url
                        fillMode: Image.PreserveAspectCrop
                        visible: game.image_url !== ""
                        clip: true
                    ...
                    // PRAWA STRONA: Zawartość tekstowa
                    ColumnLayout {
                        id: rightColumn
                        Layout.fillWidth: true
                        Layout.fillHeight: true
                        ...
                        Repeater {
                            ...
                            delegate: ColumnLayout {
                                ...
                                Rectangle {
                                    Layout.fillWidth: true
                                    height: commentText.implicitHeight + 20
                                    color: "#f8f9fa"
                                    border.color: "#dee2e6"
                                    border.width: 1
                                    radius: 8
                        ...
                        RowLayout {
                            ...
                            TextField {
                                ...
                                Layout.fillWidth: true
                                background: Rectangle { color: "#f8f9fa"; border.color: "#ced4da"; radius: 20 }
                                leftPadding: 15
                            }
                            Button {
                                text: "Wyślij"
                                background: Rectangle { color: "#0d6efd"; radius: 20 }
                                contentItem: Text { text: parent.text; color: "white"; font.bold: true; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter }
                                onClicked: {
                                    if(commentInput.text !== "") {
                                        sendComment(game.title, commentInput.text, commentInput);
                                    }
                                }
                            }
                        }
    ...
    // ==========================================
    // POP-UP POTWIERDZENIA USUNIĘCIA KONTA
    // ==========================================
    Popup {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Button {
                        text: "Anuluj"
                        background: Rectangle { color: "#e2e6ea"; radius: 5 }
                        onClicked: deleteAccountPopup.close()
                    }

                    Button {
                        text: "Tak, usuń"
                        background: Rectangle { color: "#dc3545"; radius: 5 }
                        contentItem: Text { text: parent.text; color: "white"; font.bold: true; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter }
                        onClicked: deleteMyAccount()
                    }
                }
            }
        }
            ...
            if (xhr.readyState === XMLHttpRequest.DONE) {
                if (xhr.status === 200) {
                    try {
                        ...
                        statusLabel.text = "Błąd parsowania danych.";
                        statusLabel.visible = true;
                    }
                } else {
    ...
    function addNewGame() {
        if(inputTitle.text === "" || inputDev.text === "") {
            addStatusLabel.text = "Tytuł i Deweloper są wymagane!";
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState === XMLHttpRequest.DONE) {
                if (xhr.status === 201) {
                    ...
                    inputTitle.text = ""; inputDev.text = ""; inputYear.text = "";
                    inputGenre.text = ""; inputSubgenre.text = ""; inputTheme.text = "";
                    inputEngine.text = ""; inputPlaytime.text = "";
                    inputDifficulty.currentIndex = 1;
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState === XMLHttpRequest.DONE) {
                if (xhr.status === 200 || xhr.status === 201) {
                    inputFieldReference.text = "";
                    fetchGames();
                } else {
                    console.error("Błąd dodawania komentarza:", xhr.responseText);
                }
            }
        };
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState === XMLHttpRequest.DONE) {
                if (xhr.status === 200 || xhr.status === 204) {
                    ...
                    console.error("Błąd usuwania konta:", xhr.responseText);
                }
            }
        };
        xhr.send();
